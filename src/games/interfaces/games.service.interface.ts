...
export interface GamesServiceInterface {
  ...
  findAll(query: PaginateQuery, currentUser: User, includeCancelled?: boolean): Promise<Paginated<Game>>;
  ...
  findUserHistory(userId: string, query?: PaginateQuery, includeCancelled?: boolean): Promise<Paginated<Game>>;
